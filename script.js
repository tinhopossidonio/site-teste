// script.js (Versão 16.0 - Botão do Pop-up Corrigido)
console.log('Script.js loaded - Version 16.0');
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Adiciona event listener ao botão "Adicionar ao Carrinho" dentro do modal
  // Este é o ponto crucial para garantir que o botão no modal funciona.
  const adicionarComSaboresButton = document.getElementById('adicionar-com-sabores-btn');
  if (adicionarComSaboresButton) {
    console.log('Anexando listener ao botão "Adicionar ao Carrinho" do modal.');
    adicionarComSaboresButton.addEventListener('click', adicionarComSabores);
  } else {
    console.error('Erro: Botão "Adicionar ao Carrinho" do modal (id="adicionar-com-sabores-btn") não encontrado.');
  }


  // Adiciona event listener para a barra de pesquisa
